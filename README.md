...
This code represents a C# program that interacts with a SQL Server database. 
It provides a simple command-line interface for performing CRUD (Create, Read, Update, Delete) operations on student records stored in a database table named "KutuphaneKayit". 
Users can choose operations like adding, updating, deleting, and listing student information through the command-line menu. 
The program uses ADO.NET to establish a connection to the database, execute SQL queries, and manage data retrieval and manipulation.
